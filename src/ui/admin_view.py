...
Vollbild-Layout mit eigener Sidebar-Navigation (10 Bereiche):
...
from PySide6.QtWidgets import (
    ...
    QPushButton, QLabel, QDialog, QFormLayout, QLineEdit, QComboBox, QCheckBox,
    ...
    def _on_edit_user(self):
        ...
        if dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            try:
                ...
                self._toast_manager.show_success(texts.ADMIN_USERS_UPDATED.format(username=user['username']))
                self._load_users()
            except APIError as e:
                self._toast_manager.show_error(str(e))
