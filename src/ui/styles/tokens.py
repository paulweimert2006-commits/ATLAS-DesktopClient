...
APP_SIDEBAR_WIDTH_EXPANDED = 275
APP_SIDEBAR_WIDTH_COLLAPSED = 56
APP_SIDEBAR_NAV_HEIGHT = 48
APP_SIDEBAR_SECTION_PADDING = "8px 20px"
APP_SIDEBAR_ANIM_DURATION_MS = 320
KPI_CARD_MIN_HEIGHT = 80
