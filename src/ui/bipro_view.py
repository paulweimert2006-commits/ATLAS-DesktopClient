...
class BiPROView(QWidget):
    ...
    def _setup_ui(self):
        ...
        from i18n.de import (
            ...
            ACC_REFRESH_PREVIEW, ACC_ADMIN_TOGGLE, ACC_ACK_ALL,
        )
        ...
        self._refresh_btn.setToolTip(f"{ACC_REFRESH_PREVIEW} (Strg+R)")
        ...
        self._admin_toggle.setToolTip(f"{ACC_ADMIN_TOGGLE} (Strg+T)")
