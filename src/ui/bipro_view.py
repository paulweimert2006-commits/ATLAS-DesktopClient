...
class BiPROView(QWidget):
    ...
    def _setup_ui(self):
        ...
        from i18n.de import (
            ...
            ACC_BIPRO_FETCH_ALL, ACC_BIPRO_FETCH_MAIL, ACC_BIPRO_FETCH_VU,
            ACC_BIPRO_REFRESH, ACC_BIPRO_ACK,
        )
        ...
        self.mail_fetch_btn.setToolTip(f"{BIPRO_MAIL_FETCH_TOOLTIP} (Strg+M)")
        self.mail_fetch_btn.setShortcut("Ctrl+M")
        self.mail_fetch_btn.setAccessibleName(ACC_BIPRO_FETCH_MAIL)
        ...
        self.fetch_single_vu_btn.setToolTip(f"{BIPRO_FETCH_ONLY_VU} (Umschalt+F5)")
        self.fetch_single_vu_btn.setShortcut("Shift+F5")
        self.fetch_single_vu_btn.setAccessibleName(ACC_BIPRO_FETCH_VU)
        ...
        self._refresh_btn.setToolTip(f"{BIPRO_PREVIEW_REFRESH_TOOLTIP} (Strg+R)")
        ...
        self._ack_btn.setAccessibleName(ACC_BIPRO_ACK)
