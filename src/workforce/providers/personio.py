...
from workforce.helpers import format_date_for_display


class PersonioProvider(BaseProvider):
    """
    Provider fuer das Abrufen von Mitarbeiterdaten aus der Personio API v1.
    ...
    KEY_TO_LABEL_MAP = {
        ...
        "employment_type": "Beschaeftigungsart", "weekly_working_hours": "Wochenstunden",
        "hire_date": "Eintrittsdatum", "contract_end_date": "Vertragsende",
        "termination_date": "Kuendigungsdatum", "termination_type": "Art der Kuendigung",
        "termination_reason": "Kuendigungsgrund", "probation_period_end": "Probezeitende",
        "created_at": "Erstellt am", "last_modified_at": "Letzte Aenderung",
        ...
        "dynamic_16291410": "Strasse", "dynamic_16291415": "Persoenliche E-Mail",
        ...
        "dynamic_16291389": "Krankenversicherung", "dynamic_16291401": "Nationalitaet",
        "dynamic_16291408": "Postleitzahl", "dynamic_16291397": "Haupt-/Nebenarbeitgeber",
        "dynamic_16291399": "Studienbescheinigung gueltig bis", "dynamic_16291409": "Ort",
        "dynamic_16291398": "Kinderfreibetrag", "dynamic_16291400": "Abrechnungsart",
        "dynamic_16291402": "Kuendigungsfrist", "dynamic_16291404": "Hoechster Schulabschluss",
        "dynamic_16291403": "Beschaeftigungsart", "dynamic_16291405": "Hoechster Ausbildungsabschluss",
    ...
    def _fetch_profile_picture_as_data_uri(self, url: str) -> str | None:
        """Laedt Profilbild und konvertiert zu Data-URI."""
