"""
Utility-Funktionen für das HR-Modul.
...
def get_safe_employer_name(name: str) -> str:
    ...
    Quelle: app.py Zeilen 366-376

    Args:
        name: Ursprünglicher Arbeitgeber-Name

    Returns:
        Bereinigter Name, sicher für Dateinamen
    """
...
def parse_date(date_str: str) -> datetime | None:
    """
    Parst einen Datumsstring aus gängigen Formaten.
    
    Quelle: app.py Zeilen 397-413
...
def json_hash(rec: dict) -> str:
    ...
    Quelle: app.py Zeilen 2509-2520
...
def flatten_record(obj, prefix="", out=None) -> dict:
    ...
    Quelle: app.py Zeilen 2522-2542

    Args:
        obj: Zu flachendes Objekt
        prefix: Schlüssel-Präfix
        out: Ausgabe-Dictionary (für Rekursion)
...
def person_key(detail: dict) -> str | None:
    ...
    Quelle: app.py Zeilen 2544-2555
